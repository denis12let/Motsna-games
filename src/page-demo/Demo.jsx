...
import { FiSmartphone, FiCode, FiDownload, FiCommand, FiHeadphones, FiBold, FiArrowUp } from 'react-icons/fi';
              ...
              <div className="col-lg-12">
                <div className="section-title text-center pb--30 pb_sm--0 pb_md--0">
                  ...
                  <p className="text-white">
                    Trydo are designed for everyone. It doesn’t matter if you’re a React <br />
            ...
            <div className="row row--35">
              <div className="col-lg-6 col-md-12 col-12">
                <div className="inner">
                  ...
                  <p>
                    Trydo Page speed is so faster and takes byte times for load each page. It's is very easy to use, loads faster and
              ...
              <div className="col-lg-12 col-xl-6 offset-xl-6">
                <div className="inner">
                  <div className="section-title">
                    ...
                    <p>
                      Trydo site works seamlessly on any device without a single compromise, will always looks cool and great on any mobile
                      device or browsers. Its easily adapt your content for mobile, tablet and so on.
                    </p>
                  </div>
                  ...
                  <Accordion className="accodion-style--1" preExpanded={'0'}>
                    <AccordionItem>
                      <AccordionItemHeading>
                        <AccordionItemButton>1. What is tryDo ? How does it work?</AccordionItemButton>
                      </AccordionItemHeading>
                      <AccordionItemPanel>
                        <p>
                          Welcome to TryDO React Creative Agency, React Portfolio and Corporate Multi Purpose Template Built With React JS.
                          NO jQuery!. It works too much faster loading speed and you can works too much comfortability.Trydo create your
                          website so much faster, use to use and Well Documented Codes for your customization.
                        </p>
                      </AccordionItemPanel>
                    </AccordionItem>
                    ...
                    <AccordionItem>
                      <AccordionItemHeading>
                        <AccordionItemButton>2. How can I run trydo react template?</AccordionItemButton>
                      </AccordionItemHeading>
                      <AccordionItemPanel>
                        <p>
                          You can run trydo easily. First You'll need to have node and npm on your machine. So Please open your command
                          prompt then check your node -v and npm -v Version. Goes To Your your command prompt: then First:{' '}
                          <strong>yarn install</strong>
                        </p>
                        <p>
                          At Last: <strong>yarn start</strong>. By the following way you can be run your project easily.
                        </p>
                      </AccordionItemPanel>
                    </AccordionItem>
                    ...
                    <AccordionItem>
                      <AccordionItemHeading>
                        <AccordionItemButton>3. How can I change my demo page instead of splash page?</AccordionItemButton>
                      </AccordionItemHeading>
                      <AccordionItemPanel>
                        <div>
                          <p>
                            You can be presenting any home page instead of splash page. http://localhost:3000 you can showing any page as
                            your you are like. First you have to go index.js page then:
                          </p>
                          <p>
                    ...
                    <AccordionItem>
                      <AccordionItemHeading>
                        <AccordionItemButton>4. How can I get the customer support?</AccordionItemButton>
                      </AccordionItemHeading>
                      <AccordionItemPanel>
                        <p>
                    ...
                    <AccordionItem>
                      <AccordionItemHeading>
                        <AccordionItemButton>5. Can I get update regularly and For how long do I get updates?</AccordionItemButton>
                      </AccordionItemHeading>
                      <AccordionItemPanel>
                        <p>
                          Yes, We will get update the Trydo. And you can get it any time. Next time we will comes with more feature. You can
                          be get update for unlimited times. Our dedicated team works for update.
                        </p>
                      </AccordionItemPanel>
                    </AccordionItem>
                    ...
                    <AccordionItem>
                      <AccordionItemHeading>
                        <AccordionItemButton>6. Can I change any component as I like?</AccordionItemButton>
                      </AccordionItemHeading>
                      <AccordionItemPanel>
                        <p>
                    ...
                    <AccordionItem>
                      <AccordionItemHeading>
                        <AccordionItemButton>7. Can I build a complete project with this template?</AccordionItemButton>
                      </AccordionItemHeading>
                      <AccordionItemPanel>
                        <p>
                          Yes, Why not. You can build a project and complete website as you are like. More component are available include
                          in this templete. And you can be use it following documentation.
                        </p>
                      </AccordionItemPanel>
                    </AccordionItem>
                  </Accordion>
                ...
                <div className="card-box text-left">
                  <div className="service">
                    ...
                    <div className="content">
                      ...
                      <a target="_blank" href="#" className="rbt-button rn-button-style--2 rn-btn-small-2 btn-solid-border">
                        <span className="button-text">Online Documentation</span>
                      </a>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="pv-testimonial">
                      <div className="inner">
                        ...
                        <div className="content">
                          ...
                          <p>
                            The product is of good quality and easy to use, We are also the author on Envato and our requirement is very
                            high, Affordable and excellent...
                          </p>
                    ...
                    <div className="pv-testimonial">
                      <div className="inner">
                        ...
                        <div className="content">
                          <h5>Design Quality</h5>
                          <p>
                            The configuration of the contact form was problematic, but the support of the Rainbow team helped a lot. That
                            convinced me! Thanks!
                          </p>
                          <div className="rating">
                            <img src={rating} alt="Rating Images" />
                    ...
                    <div className="pv-testimonial">
                      <div className="inner">
                        ...
                        <div className="content">
                          ...
                          <p>Excellent design template and easy to customize if you know React. Good value.</p>
                          <div className="rating">
                            <img src={rating} alt="Rating Images" />
                          </div>
                        </div>
                    ...
                    <div className="pv-testimonial">
                      <div className="inner">
                        ...
                        <div className="content">
                          ...
                          <p>Perfectly support. Well deserved 5 star for code and design quality.</p>
                          <div className="rating">
                            <img src={rating} alt="Rating Images" />
                          </div>
                        </div>
                    ...
                    <div className="pv-testimonial">
                      <div className="inner">
                        ...
                        <div className="content">
                          <h5>Customer Support</h5>
                          <p>
                            The best customer support I've ever received on Envato. The author is absolutely great and he's always so fast
                            to answer...
                          </p>
                          <div className="rating">
                            <img src={rating} alt="Rating Images" />
                    ...
                    <div className="pv-testimonial">
                      <div className="inner">
                        ...
                        <div className="content">
                          <h5>Customer Support</h5>
                          <p>
                            Simply amazing support... TOP Seller in terms of support... Thanks a lot... I will keep buying your products...
                            amazing work... bug free... thanks a lot...
                          </p>
                          <div className="rating">
                            <img src={rating} alt="Rating Images" />
                          </div>
